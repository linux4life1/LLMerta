...
mixin _$GameSession {
 ...
 GameStage get stage; List<GameEvent> get visibleEvents; int get humanSeat; List<String> get names; Map<int, String> get modelBadges; Map<int, Persona> get personas; bool get humanIsMafia; Scene? get scene; String? get townName; Faction? get winner; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,stage,const DeepCollectionEquality().hash(visibleEvents),humanSeat,const DeepCollectionEquality().hash(names),const DeepCollectionEquality().hash(modelBadges),const DeepCollectionEquality().hash(personas),humanIsMafia,scene,townName,winner,error);

@override
String toString() {
  return 'GameSession(stage: $stage, visibleEvents: $visibleEvents, humanSeat: $humanSeat, names: $names, modelBadges: $modelBadges, personas: $personas, humanIsMafia: $humanIsMafia, scene: $scene, townName: $townName, winner: $winner, error: $error)';
}
...
@useResult
$Res call({
 GameStage stage, List<GameEvent> visibleEvents, int humanSeat, List<String> names, Map<int, String> modelBadges, Map<int, Persona> personas, bool humanIsMafia, Scene? scene, String? townName, Faction? winner, String? error
});
...
/// Create a copy of GameSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? stage = null,Object? visibleEvents = null,Object? humanSeat = null,Object? names = null,Object? modelBadges = null,Object? personas = null,Object? humanIsMafia = null,Object? scene = freezed,Object? townName = freezed,Object? winner = freezed,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( GameStage stage,  List<GameEvent> visibleEvents,  int humanSeat,  List<String> names,  Map<int, String> modelBadges,  Map<int, Persona> personas,  bool humanIsMafia,  Scene? scene,  String? townName,  Faction? winner,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameSession() when $default != null:
return $default(_that.stage,_that.visibleEvents,_that.humanSeat,_that.names,_that.modelBadges,_that.personas,_that.humanIsMafia,_that.scene,_that.townName,_that.winner,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( GameStage stage,  List<GameEvent> visibleEvents,  int humanSeat,  List<String> names,  Map<int, String> modelBadges,  Map<int, Persona> personas,  bool humanIsMafia,  Scene? scene,  String? townName,  Faction? winner,  String? error)  $default,) {final _that = this;
switch (_that) {
case _GameSession():
return $default(_that.stage,_that.visibleEvents,_that.humanSeat,_that.names,_that.modelBadges,_that.personas,_that.humanIsMafia,_that.scene,_that.townName,_that.winner,_that.error);case _:
  throw StateError('Unexpected subclass');
...
class _GameSession implements GameSession {
  const _GameSession({this.stage = GameStage.idle, final  List<GameEvent> visibleEvents = const [], this.humanSeat = 0, final  List<String> names = const [], final  Map<int, String> modelBadges = const {}, final  Map<int, Persona> personas = const {}, this.humanIsMafia = false, this.scene, this.townName, this.winner, this.error}): _visibleEvents = visibleEvents,_names = names,_modelBadges = modelBadges,_personas = personas;
...
@override
int get hashCode => Object.hash(runtimeType,stage,const DeepCollectionEquality().hash(_visibleEvents),humanSeat,const DeepCollectionEquality().hash(_names),const DeepCollectionEquality().hash(_modelBadges),const DeepCollectionEquality().hash(_personas),humanIsMafia,scene,townName,winner,error);
...
/// Create a copy of GameSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? stage = null,Object? visibleEvents = null,Object? humanSeat = null,Object? names = null,Object? modelBadges = null,Object? personas = null,Object? humanIsMafia = null,Object? scene = freezed,Object? townName = freezed,Object? winner = freezed,Object? error = freezed,}) {
