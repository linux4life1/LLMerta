...
| **Lobby (Game Setup)** | Player count slider (7–14), rule config, and the **seat grid**: one card per AI seat with persona, connection+model dropdown, sampling, voice; bulk actions |
